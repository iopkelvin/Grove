...
def create_room():
    ...
    # Turner's Create Study Room preferences, validated rather than passed
    # through: focus_minutes in particular reaches a NOT NULL integer column.
    preferences = {
        "setting": fields.string("setting", max_length=40, default=None),
        "music_enabled": fields.boolean("music_enabled", default=None),
        "chat_enabled": fields.boolean("chat_enabled", default=None),
        "focus_minutes": fields.integer(
            "focus_minutes", default=None, minimum=5, maximum=240
        ),
    }
    ...
    room = room_service.create_room(
        current_user(), name=name, theme=theme, capacity=capacity, preferences=preferences
    )
